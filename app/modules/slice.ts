...
export const { selected, saveTwitchSession, saveYoutubeSession, saveLoginSession, twitchChannels, youtubeChannels, selectPlatform, saveSearchResult, selectView, selectScreen } = Slice.actions
