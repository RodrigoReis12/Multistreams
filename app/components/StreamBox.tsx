...
const YoutubeChat = ({id}: ChatProps) => {
  ...
  return (
    <>
      <iframe width="280" height="100%" src={endpoint} frameBorder="0" />
    </>
  )
}
  ...
  return (
    <div className='h-min[550px] h-full shadow-2xl shadow-indigo-500/50'>
      {platform === "twitch" &&
        <div className='grid grid-cols-4 h-full'>
          <div className={chatClass}>
            <ReactPlayer className="react-player" url={twitchEndpoint} width="100%" height="100%" playing controls={true} />
          </div>
...

      {
        ...
        <div className='grid grid-cols-4 h-full'>
          <div className={chatClass}>
            <ReactPlayer className="react-player" url={youtubeEndpoint} width="100%" height="100%" playing controls={true} />
          </div>
